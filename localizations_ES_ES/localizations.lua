...
localizations.values = {
    ...
    research_fire_description = "Tu Tribu descubrió que el calor se genera a partir de la fricción cuando frotas dos ramas. Si se calienta lo suficiente, se puede producir una brasa para iniciar un fuego, proporcionando calor y luz.",
    ...
    desire_restDescriptions_strong = "Trabajo em Excesso",
    ...
    statusEffect_overworked_name = "Trabajo en Excesso",
    ...
    skill_woodWorking_description = "Crea cosas a partir de ramas y troncos.",
    ...
    -- Seleccion Grupos
    selectionGroup_branch_objectName = "Rama",
    selectionGroup_branch_plural = "Ramas",
    selectionGroup_branch_descriptive = "Cualquier Rama",
...
Mucho CUIDADO! Instale mods por su propio riesgo. Incluso las modificaciones en Steam Workshop pueden contener y ejecutar código que puede dañar su computadora. Solo instale y active mods de autores en los que confíe.",
    ...
    tutorial_storingResources_storeTip_b = "Puedes recoger ramas de los árboles.",
    ...
    tutorial_research_branch = "Investigar Rama",
   ...
   -- Final Tutorial
    ...
    tutorial_subtitle_investigateLine2 = "Seleciona una Piedra o Rama e investígala.",
